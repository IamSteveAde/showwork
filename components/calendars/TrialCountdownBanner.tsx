...
return ( <svg
   ...
   aria-hidden="true"
 > <path d="M12 2.5l1.55 5.95L19.5 10l-5.95 1.55L12 17.5l-1.55-5.95L4.5 10l5.95-1.55L12 2.5Z" /> <path d="M19 16.5l.7 2.8 2.8.7-2.8.7-.7 2.8-.7-2.8-2.8-.7 2.8-.7.7-2.8Z" /> </svg>
);
}
...
const price = plan === "STUDIO" ? "₦15,000" : "₦2,800";
const planName = plan === "STUDIO" ? "Studio" : "Creator";
...
try {
  const res = await fetch("/api/calendars/subscribe", {
    method: "POST",
    headers: {
