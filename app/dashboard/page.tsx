...
function PortfolioIcon({ className = "h-5 w-5" }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className} aria-hidden>
      ...
      <circle cx="8.5" cy="9" r="1.5" stroke="currentColor" strokeWidth="1.4" />
...
function DeliveryIcon({ className = "h-5 w-5" }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className} aria-hidden>
      ...
      <path d="m15.5 16.5 2.5-2.5 2.5 2.5" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
function WorkspaceIcon({ className = "h-5 w-5" }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className} aria-hidden>
      ...
      <path d="M7 13h3M14 13h3M7 16.5h3M14 16.5h3" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" />
    </svg>
  );
}
...
function CommunityIcon({ className = "h-5 w-5" }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className} aria-hidden>
      ...
      <path d="M3.5 19c.5-3.2 2.5-5 5.5-5s5 1.8 5.5 5M15 15c2.8 0 4.6 1.4 5 4" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" />
    </svg>
  );
}
  ...
  return (
    <main className="min-h-screen bg-[#F7F8FA] text-[#101114]">
      ...
      <header className="sticky top-0 z-50 border-b border-[#E8EAEE] bg-white/95 backdrop-blur-xl">
        <div className="mx-auto flex h-16 max-w-[1280px] items-center justify-between px-4 sm:h-[70px] sm:px-6 lg:px-8">
          <Link href="/dashboard" aria-label="Showwork home" className="shrink-0">
            <Logo />
          </Link>
...
>
  ...
  <div className="hidden sm:block">
    <LogoutButton />  
      ...
      <div className="mx-auto max-w-[1280px] px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <section className="pt-10 sm:pt-14 lg:pt-16">
          <div className="flex flex-col gap-7 lg:flex-row lg:items-end lg:justify-between">
            ...
            <div className="flex items-center gap-2 text-xs text-[#7B828D]">
              ...
              <span>{calendar ? "Content workspace ready" : "No content workspace yet"}</span>
            </div>
          </div>
        </section>
        ...
        <section className="mt-10 sm:mt-12">
          <div className="mb-5 flex items-center justify-between">
            <div>
              ...
              <h2 className="mt-1 text-xl font-semibold tracking-[-0.03em]">Choose where to work</h2>
            </div>
            <span className="hidden text-xs text-[#969CA5] sm:block">4 environments</span>
          </div>

          {/* Featured workspace */}
          <Link
            href="/dashboard/calendars"
            className="group relative block overflow-hidden rounded-[28px] border border-[#CFE0FF] bg-[#EEF5FF] shadow-[0_18px_55px_rgba(36,120,255,0.08)] transition duration-300 hover:-translate-y-0.5 hover:border-[#B9D1FA] hover:shadow-[0_24px_70px_rgba(36,120,255,0.12)]"
          >
            ...
            <div className="relative grid gap-8 p-6 sm:p-8 lg:grid-cols-[1fr_auto] lg:items-end lg:p-10">
              <div className="max-w-2xl">
                ...
                <div className="mt-6 flex flex-wrap gap-2">
                  {["AI Studio", "Calendar", "Approvals", "Publishing"].map((item) => (
                    <span
                      key={item}
              ...
              <div className="flex items-center justify-between gap-5 border-t border-[#D2E0F4] pt-5 lg:min-w-[220px] lg:flex-col lg:items-end lg:border-t-0 lg:pt-0">
                ...
                <span className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full bg-[#2478FF] text-white shadow-[0_10px_25px_rgba(36,120,255,.22)] transition-transform duration-300 group-hover:translate-x-1">
                  <ArrowIcon />
                </span>
              </div>
            </div>
          ...
          {/* Three secondary apps: intentionally compact */}
          <div className="mt-4 grid gap-4 md:grid-cols-3">
            <Link
              href="/dashboard/projects"
              className="group rounded-[24px] border border-[#E0E3E8] bg-[#101114] p-6 text-white transition duration-300 hover:-translate-y-0.5 hover:shadow-[0_20px_55px_rgba(10,12,16,.13)] sm:p-7"
            >
              ...
              <p className="mt-2 min-h-[48px] text-xs leading-5 text-white/45">
                Deliver work, collect feedback and get projects across the line.
              </p>
              ...
              <div className="mt-6 flex items-center justify-between border-t border-white/10 pt-4">
                ...
                <span className="flex h-8 w-8 items-center justify-center rounded-full bg-white text-[#101114] transition group-hover:translate-x-1">
            ...
            <Link
              ...
              className="group rounded-[24px] border border-[#E0E3E8] bg-white p-6 transition duration-300 hover:-translate-y-0.5 hover:shadow-[0_20px_55px_rgba(20,30,45,.07)] sm:p-7"
            >
              <div className="flex items-center justify-between">
              ...
              <div className="mt-6 flex items-center justify-between border-t border-[#ECEEF1] pt-4">
                ...
                <span className="flex h-8 w-8 items-center justify-center rounded-full bg-[#F1F5FC] text-[#2478FF] transition group-hover:translate-x-1">
                  <ArrowIcon className="h-3.5 w-3.5" />
                </span>
              </div>
            </Link>
            ...
            <a
              ...
              className="group rounded-[24px] border border-[#24262C] bg-[#191A1E] p-6 text-white transition duration-300 hover:-translate-y-0.5 hover:shadow-[0_20px_55px_rgba(10,10,15,.14)] sm:p-7"
            >
              <div className="flex items-center justify-between">
                <span className="flex h-10 w-10 items-center justify-center rounded-xl bg-white/[0.07] text-white ring-1 ring-white/10">
                  <CommunityIcon />
              ...
              <div className="mt-6 flex items-center justify-between border-t border-white/10 pt-4">
                ...
                <span className="flex h-8 w-8 items-center justify-center rounded-full bg-white text-[#191A1E] transition group-hover:translate-x-1">
        ...
        {/* Quick orientation — replaces the previous long support section */}
  ...
  <div className="flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
    <div className="flex items-start gap-3.5">
      ...
      <div>
        ...
        <p className="mt-1 max-w-xl text-xs leading-5 text-[#858B94]">
          Tell us what you&apos;re trying to accomplish and we&apos;ll point you
          to the right Showwork workspace. Our team is happy to help.
        </p>
      </div>
    </div>
    ...
    <a
      ...
      target="_blank"
      rel="noopener noreferrer"
      className="group inline-flex w-full shrink-0 items-center justify-center gap-2.5 rounded-xl bg-[#25D366] px-4 py-3 text-xs font-bold text-white shadow-[0_8px_20px_rgba(37,211,102,0.18)] transition-all duration-200 hover:-translate-y-0.5 hover:bg-[#20BD5A] hover:shadow-[0_10px_24px_rgba(37,211,102,0.24)] sm:w-auto"
    >
      <svg
        viewBox="0 0 24 24"
        fill="none"
      ...
      <ArrowUpRightIcon className="h-3.5 w-3.5 transition-transform duration-200 group-hover:translate-x-0.5 group-hover:-translate-y-0.5" />
        ...
        <footer className="mt-10 flex flex-col gap-3 border-t border-[#E3E5E9] pt-6 text-xs text-[#969CA5] sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex items-center gap-4">
            <Link href="/dashboard/profile" className="transition hover:text-[#2478FF]">
              Account
            </Link>
            <a
              href="mailto:hello@useshowwork.com"
              className="transition hover:text-[#2478FF]"
            >
              Support
            </a>
          </div>
